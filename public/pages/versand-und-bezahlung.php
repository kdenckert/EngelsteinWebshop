...
<?php else: ?>
    ...
    <table class="cart step2 mt20">
        <form action="" id="order-form" method="post">
            <thead>
            <tr class="radio">
                <th><input type="radio" name="customer_data[alternative_adress]" value="off" class="own" id="own"
                           checked/> <label class="own" for="own">An meine Rechnungsadresse schicken</label></th>
                <th></th>
                <th><input type="radio" name="customer_data[alternative_adress]" value="on" id="other" class="other"/>
                    <label class="other" for="other">Andere Lieferadresse angeben</label></th>
            </tr>
            </thead>
            ...
            <tr>
                <td>
                    ...
                    <input id="lastname" name="customer_data[lastname]" value="<?= @$_SESSION['lastname'] ?>"
                           type="text"/>

                    <label for="street" class="quater">Straße <span
                            style="margin-left: 240px;">Hausnummer</span></label>
                    <input class="quater" name="customer_data[street]" value="<?= @$_SESSION['street'] ?>" id="street"
                           type="text"/>
                    ...
                    <input class="tiny" name="customer_data[postcode]" value="<?= @$_SESSION['postcode'] ?>" id="plz"
                           type="text"/>
                ...
                <td class="alternative">
                    ...
                    <input id="alt_name" name="customer_data[alt_name]" value="<?= @$_SESSION['alt_name'] ?>"
                           type="text"/>

                    <label for="firstname_scnd">Nachname</label>
                    <input id="firstname_scnd" name="customer_data[alt_lastname]"
                           value="<?= @$_SESSION['alt_lastname'] ?>" type="text"/>

                    <label for="street_scnd" class="quater">Straße <span
                            style="margin-left: 240px;">Hausnummer</span></label>
                    <input class="quater" id="street_scnd" name="customer_data[alt_street]"
                           value="<?= @$_SESSION['alt_street'] ?>" type="text"/>
                    ...
                    <input class="tiny" name="customer_data[alt_postcode]" value="<?= @$_SESSION['alt_postcode'] ?>"
                           id="plz_scnd" type="text"/>
                    <input class="quater" name="customer_data[alt_city]" value="<?= @$_SESSION['alt_city'] ?>"
                           type="text"/>
                </td>
            </tr>
            <tr>
